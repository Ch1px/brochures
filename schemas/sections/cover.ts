...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: 'If set, replaces the supertitle text with an image (e.g. a small logo).',
      options: { hotspot: false },
    }),
    defineField({
      name: 'supImageScale',
      type: 'number',
      title: 'Supertitle image scale',
      description: 'Multiplier on the default size. 1 = default.',
    }),
    defineField({
      name: 'title',
      type: 'string',
    ...
    defineField({
      ...
      description: 'If set, replaces the title text with an image (e.g. an event lockup). PNG with transparent background recommended.',
      options: { hotspot: false },
    }),
    defineField({
      name: 'titleImageScale',
      type: 'number',
      title: 'Title image scale',
      description: 'Multiplier on the default size. 1 = default.',
    }),
    defineField({
      name: 'titleAccent',
    ...
    defineField({
      ...
      description: 'If set, replaces the title accent with an image (e.g. a script-style logomark).',
      options: { hotspot: false },
    }),
    defineField({
      name: 'titleAccentImageScale',
      type: 'number',
      title: 'Title accent image scale',
      description: 'Multiplier on the default size. 1 = default.',
    }),
    defineField({
      name: 'tag',
