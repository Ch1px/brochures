      ...
      of: [
        {
          ...
          fields: [
            ...
            { name: 'borderRadius', type: 'number', title: 'Image border radius (%)' },
            { name: 'mediaGrayscale', type: 'string', title: 'Image greyscale' },
            { name: 'mediaBlur', type: 'string', title: 'Image blur' },
