...
- Use a wide variety of section types — aim for at least 8 distinct \`_type\` values across the brochure (out of the 18 available).
...
export const SECTION_GUIDE = `THE 18 SECTION TYPES — WHAT EACH IS FOR:
