...
export const SECTION_LABELS: Record<Section['_type'], string> = {
  ...
  // Legacy alias — existing documents only; not exposed in the picker.
  sectionHeadingCentered: 'Section Heading',
...
export const SECTION_DESCRIPTIONS: Record<Section['_type'], string> = {
  ...
  sectionHeading: 'Chapter opener: script eyebrow + bold title (centered by default; alignment configurable)',
  sectionHeadingCentered: 'Chapter opener (legacy alias)',
  ...
  galleryTrio: '3 equal tiles in a single row',
  ...
  ctaBanner: 'Centered call-to-action with title and button',
  linkedCards: 'Side-by-side cards with images and link buttons',
